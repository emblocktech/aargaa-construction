  ...
  return (
    <NavBar>
      <Grid>
        <Grid.Row>
          <main className={"main"}>
              <motion.img initial={{y: 0, opacity: 0}} animate={{y: 0, opacity: 1}} exit={{ y: 0, opacity: 1 }} transition={{ duration: 1, type: "spring" }} src="/images/LIVING-1.jpg" style={{height: "100vh", width: "100%"}} />
