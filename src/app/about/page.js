        ...
        <NavBar>
            ...
            <Grid style={{padding: "2rem 0 2rem 0"}}>
                ...
                <Grid.Column width={16} style={{margin: "20px"}}>
                    <motion.img src="/images/LIVING-1.jpg" initial={{scale: 0, borderRadius: 0}} whileInView={{scale: 1, borderRadius: 10}} exit={{ scale: 1, borderRadius: 10 }} transition={{ duration: 1, type: "spring" }}></motion.img>
                </Grid.Column>
                </Grid.Row>
            </Grid>
            </Container>
            <div  className="content-center-middle" style={{marginBottom: "20px"}}>
                <Grid>
                    <Grid.Row style={{position: "relative", display: "inline-block"}} only={"computer tablet"}>
                        <img src="/images/LIVING-1.jpg" style={{height: "270px", width: "1700px", filter: "brightness(0.1)"}} />
